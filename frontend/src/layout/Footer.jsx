...
const Footer = () => {
    return (
        <footer className="bg-[var(--color-dark)] border-t border-white/10 pt-16 pb-8">
            <div className="max-w-[1400px] mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <p className="text-[var(--color-light-400)] text-sm leading-relaxed mb-6">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-[var(--color-light-400)]">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm text-[var(--color-light-400)]">
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-[var(--color-light-400)]">
...
const SocialLink = ({ href, icon: Icon }) => (
    <a
        href={href}
        className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-400 hover:bg-[var(--color-primary)] hover:text-white transition-all transform hover:-translate-y-1"
    >
